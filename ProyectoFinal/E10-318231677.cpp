...
//NEW// Keyframes
////////////////////////////////////////////////////////////
float posXcanica = -2.5, posYcanica = 7.5, posZcanica = 7.6;
float movCanica_x = 0.0f, movCanica_y = 0.0f;
////////////////////////////////////////////////////////////
float giroAvion = 0;
...
int main()
{
	...
	glm::vec3 posblackhawk = glm::vec3(-2.5f, 7.5f, 7.5f);

	//---------PARA TENER KEYFRAMES GUARDADOS NO VOLATILES QUE SIEMPRE SE UTILIZARAN SE DECLARAN AQUÍ
	///////////////////////////////////
	KeyFrame[0].movCanica_x = -2.5f;
	KeyFrame[0].movCanica_y = 7.5f;

	KeyFrame[1].movCanica_x = 2.7f;
	KeyFrame[1].movCanica_y = 7.5f;

	KeyFrame[2].movCanica_x = 2.7f;
	KeyFrame[2].movCanica_y = -2.7f;

	KeyFrame[3].movCanica_x = -0.4f;
	KeyFrame[3].movCanica_y = -2.7f;

	KeyFrame[4].movCanica_x = 1.0f;
	KeyFrame[4].movCanica_y = -0.5f;

	KeyFrame[5].movCanica_x = 1.8f;
	KeyFrame[5].movCanica_y = -0.9f;

	KeyFrame[6].movCanica_x = -0.1f;
	KeyFrame[6].movCanica_y = 7.5f;

	KeyFrame[7].movCanica_x = 2.6f;
	KeyFrame[7].movCanica_y = 7.5f;
	//////////////////////////////////
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// granada obstaculo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.3, 8.0f, 7.3));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.7f , 7.75f, 14.0f ));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-3.4f, 7.75f, 14.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		model = glm::rotate(model, -45 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		...
		// canica
		model = glm::mat4(1.0);
		posblackhawk = glm::vec3(posXcanica + movCanica_x,  posZcanica, posYcanica + movCanica_y);
		...
		// pinball
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.3f , -2.0f, 7.9f));
